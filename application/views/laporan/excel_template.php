...
<head>
    <meta charset="utf-8">
    <style>
        .title { font-family: Arial; font-size: 16pt; font-weight: bold; text-align: center; }
        .subtitle { font-family: Arial; font-size: 11pt; text-align: center; }
        ...
        .date-format { mso-number-format: "Short Date"; text-align: center; }
