                    ...
                    <div class="col-lg-7 mx-auto text-white">
                        <div class="row align-items-center d-flex flex-row">
                            ...
                            <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                                <h5>Error 405 - Method Not Allowed</h5>
                                <p>The requested method is not allowed for the requested URL.</p>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-12 text-center mt-xl-2">
                                <!-- <a class="text-white font-weight-medium" href="<?php echo base_url('home') ?>">Back to home</a> -->
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-12 mt-xl-2">
                                <p class="text-white font-weight-medium text-center">Copyright &copy; 2022 BPKAD Pemerintah Kota Surabaya.</p>
                            </div>
                        </div>
                    </div>
                </div>
