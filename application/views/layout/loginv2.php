...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?php echo base_url() ?>assets2/logo.png" />
    <!--===============================================================================================-->
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form method="POST" action="<?php echo base_url('auth/check_captcha') ?>" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        ...
                        <!-- <input class="input100" type="text" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" placeholder="User Name "> -->
                        <?= crsf() ?>
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button id="btn_cap" type="button" style="border-radius: 17px; background-color: #57b846; font-size: 17px;" class="btn"> Kode Lain</button>
                                <br />
                            </div>
                            <br>
                            <br>
                            <input type="text" class="input100" name="captcha" placeholder="Masukkan Captcha">
                            <br>
                            <br>
                        </div>
                    </div>
