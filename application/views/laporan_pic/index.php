            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors align-top">
                    ...
                    <td class="px-2 py-6 text-center bg-blue-50/20">
                        <details class="group">
                            ...
                            <div class="mt-3 text-left px-3 py-2 bg-white border border-blue-100 rounded-lg shadow-inner max-w-xs mx-auto">
                                ...
                                <?php endforeach; else: echo "<p class='text-[10px] italic text-slate-400'>Kosong</p>"; endif; ?>
                            </div>
                        </details>
                    </td>
                    ...
                    <td class="px-4 py-6 text-center">
                        <a href="<?= base_url('laporan_pic/detail/'.$row['id']) ?>" 
...
<style>
    ...
    @media print {
        ...
        .shadow-sm, .shadow-md, .shadow-lg { shadow: none !important; border: 1px solid #eee; }
    }
</style>