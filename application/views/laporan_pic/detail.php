                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1 w-full">
                    <div class="bg-slate-800/50 p-5 rounded-3xl border-t-4 border-blue-500 backdrop-blur-sm">
                        ...
                        <div class="flex justify-between items-end">
                            <div>
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Proses</p>
                                <p class="text-2xl font-black text-white"><?= $stats['nonlit']['proses'] ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Selesai</p>
                                <p class="text-2xl font-black text-emerald-400"><?= $stats['nonlit']['selesai'] ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-slate-800/50 p-5 rounded-3xl border-t-4 border-red-500 backdrop-blur-sm">
                        ...
                        <div class="flex justify-between items-end">
                            <div>
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Proses</p>
                                <p class="text-2xl font-black text-white"><?= $stats['lp']['proses'] ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Selesai</p>
                                <p class="text-2xl font-black text-emerald-400"><?= $stats['lp']['selesai'] ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-slate-800/50 p-5 rounded-3xl border-t-4 border-amber-500 backdrop-blur-sm">
                        ...
                        <div class="flex justify-between items-end">
                            <div>
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Proses</p>
                                <p class="text-2xl font-black text-white"><?= $stats['masalah']['proses'] ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-[9px] text-slate-500 uppercase font-bold">Selesai</p>
                                <p class="text-2xl font-black text-emerald-400"><?= $stats['masalah']['selesai'] ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <?php foreach ($projects as $p): ?>
                        <div class="bg-white p-5 rounded-2xl border border-slate-100 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <a href="<?= base_url('nonlit/detail/' . encrypt_url($p['id'])) ?>"
