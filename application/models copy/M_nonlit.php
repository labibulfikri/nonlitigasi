...
class M_nonlit extends CI_Model
{
    ...
    function make_query()
    {
        ...
        $table = "nonlits";
        $select_column = "
         nonlits.id, permohonan_nonlit, updated_by,tgl_nonlit, penyimpanan_rak,username, team_nonlit,status, keterangan, bidang, status, register_baru, luas, pic, alamat,updated_by, updated_at";
