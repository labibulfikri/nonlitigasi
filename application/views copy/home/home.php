<div class="container">
    <br />
    <br />
    <h3 class="text-black mt-20">Welcome, <?= $this->session->userdata('username') ?></h3>
    <h6 class="font-weight-normal mb-0">Sistem Informasi Non-Litigasi BPKAD Pemerintah Kota Surabaya</h6>
    <br />
    <br />
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5" id="staticBackdropLabel"> Kejaksaan Tinggi Jawa Timur </h1>
